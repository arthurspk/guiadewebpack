# Como contribuir com o Guia de Webpack
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique (quando o nome não é autoexplicativo).
4. **Ordem:** dentro de cada seção, recursos em português e gratuitos vêm primeiro; recursos pagos ou em outro idioma dizem isso na própria descrição.
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-webpack`).
2. Edite o `README.md`.
